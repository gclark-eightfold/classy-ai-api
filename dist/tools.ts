...
export const tools = {
  ...
  fetchBillingDedication: tool({
    ...
    parameters: jsonSchema<any>({
      type: "object",
      properties: {
        with: { type: "array", items: { type: "string", enum: ["ecard"] } },
        id: { type: "integer" },
      },
    }),
    execute: async (args) => {
      ...
      properties: {
        requestBody: {
          ...
          properties: {
            ...
            city: { description: "Dedication contact city", type: "string" },
            state: {
            ...
            is_gift_amount_msg_included: {
              description:
                "Indicates whether the gift amount is to be displayed in communication",
              type: "boolean",
            },
            ecard_message: {
              ...
              properties: {
                ...
                reprocess_attempt_info: {
                  ...
                  properties: {
                    ...
                    pp_transaction_id: {
                      description:
                        "Transaction ID for the payment provider (e.g. Classy Pay)",
                      type: "string",
                    },
                    state: {
                ...
                items: {
                  ...
                  items: {
                    ...
                    properties: {
                      ...
                      raw_overhead_amount: {
                        description:
                          "Which indicates the amount of the `raw_final_price` that is attributed to Campaign overhead.",
                        type: ["null", "number"],
                        format: "double",
                        minimum: 0,
                      },
  ...
  listTransactionReceipts: tool({
    description:
      "Retrieves a list of all Transaction Receipts for a specific Transaction",
    parameters: jsonSchema<any>({
      type: "object",
      properties: {
        transaction_id: { type: "integer" },
  ...
  listCampaignActivities: tool({
    description:
      "Retrieves a list of all Activities related to the specified Campaign",
    parameters: jsonSchema<any>({
      type: "object",
      properties: {
        campaign_id: { type: "integer" },
            ...
            metadata: {
              ...
              properties: {
                employer_match_on_donation_page: {
                  description:
                    "Indicates whether there is an employer match on donation page",
                  type: "boolean",
                },
                employer_match_on_thankyou_page: {
                  description:
                    "Indicates whether there is an employer match on thankyou page",
                  type: "boolean",
                },
                employer_match_preselect: {
                  description:
                    "Indicates whether there is an employer match preselect",
                  type: "boolean",
                },
              },
              type: "object",
  ...
  listCampaignCredentialSets: tool({
    description:
      "Retrieves a list of all Credential Sets for the specified Campaign",
    parameters: jsonSchema<any>({
      type: "object",
      properties: {
        campaign_id: { type: "integer" },
  ...
  listCampaignDonationMatchingPlans: tool({
    description:
      "Retrieves a list of all Donation Matching Plans for specified Campaign",
    parameters: jsonSchema<any>({
      type: "object",
      properties: { campaign_id: { type: "integer" } },
    }),
      ...
      properties: {
        requestBody: {
          ...
          properties: {
            ...
            currency_code: {
              description:
                "Currency in which the Donation Matching Plan matches donations. The currency cannot be modified after the DonationMatchingPlan is created.",
              type: "string",
            },
            matching_limit_amount: {
              description:
                "Total amount in the Donation Matching Plan currency the sponsor is willing to match. 0 means unlimited.",
              type: "number",
              minimum: 0,
            },
            started_at: {
              description:
                "Date/time of the beginning of the sponsor's matching period",
              type: "string",
              format: "date-time",
            },
            ended_at: {
              description:
                "Date/time of the end of the sponsor's matching period. The value must be after the `started_at` value.",
              type: "string",
              format: "date-time",
            },
            business_name: {
              description:
                "Name of the sponsor. Will be displayed in feed items when matching donations",
              type: "string",
            },
            timezone_identifier: {
            ...
            matched_amount: {
              description:
                "Total amount the sponsor has currently matched, in the currency of the Donation Matching Plan",
              type: "integer",
              minimum: 0,
              readOnly: true,
            },
            asset_id: {
              description:
                "Primary identifier of sponsor thumbnail Asset which will be displayed in Feed Items",
              type: ["null", "integer"],
            },
            created_at: {
              description: "Date/time of initial record creation",
          ...
          allOf: [
            ...
            },
            {
              properties: {
                domain_id: {
                  description:
                    "Primary identifier of associated Domain. If none provided, the default Domain will be used.",
                  type: "integer",
                },
              },
              type: "object",
  ...
  listEcards: tool({
    description:
      "Retrieves a list of all eCards made for the specified Campaign",
    parameters: jsonSchema<any>({
      type: "object",
      properties: {
        campaign_id: { type: "integer" },
      ...
      properties: {
        requestBody: {
          ...
          properties: {
            ...
            order: {
              description:
                "Display order for listings. Impacts display in Classy.org",
              type: "integer",
            },
          },
          type: "object",
  ...
  listCampaignFeedItemsScoped: tool({
    ...
    parameters: jsonSchema<any>({
      ...
      properties: {
        campaign_id: { type: "integer" },
        scope: { type: "string", enum: ["direct", "all"] },
        page: { type: "integer" },
        per_page: { type: "integer" },
      },
    }),
      ...
      properties: {
        requestBody: {
          ...
          properties: {
            ...
            name: { description: "Team name", type: "string", maxLength: 127 },
            postal_code: {
      ...
      properties: {
        requestBody: {
          ...
          properties: {
            enum_options: {
              description:
                "Enum question options. Required for and exclusive to enum question type.",
              type: ["null", "array"],
              items: {
            ...
            label: { description: "Question label", type: "string" },
            location: {
              description:
                "Question location, must be valid for campaign type. donation_page supported by all, team_creation supported by reg_w_fund and p2p, page_creation supported by p2p, campaign_registration supported by p2p and ticketed.",
              type: "string",
              enum: [
                "donation_page",
                "team_creation",
            ...
            tag: {
              description:
                "Question tag, must be unique for location on a campaign",
              type: ["null", "string"],
              enum: [
                "address",
                "address2",
  ...
  listCampaignRegistrations: tool({
    description:
      "Retrieves a list of all Registrations for a specific Campaign",
    parameters: jsonSchema<any>({
      type: "object",
      properties: {
        campaign_id: { type: "integer" },
  ...
  listCampaignSourceTrackingCodes: tool({
    ...
    parameters: jsonSchema<any>({
      ...
      properties: {
        campaign_id: { type: "integer" },
        fundraisingTeams: { type: "boolean", default: false },
        fundraisingPages: { type: "boolean", default: false },
  ...
  listCampaignStaffNotificationSettings: tool({
    ...
    parameters: jsonSchema<any>({
      ...
      properties: {
        campaign_id: { type: "integer" },
        with: { type: "array", items: { type: "string", enum: ["scope"] } },
        page: { type: "integer" },
        per_page: { type: "integer" },
      },
    }),
          ...
          allOf: [
            {
              properties: {
                ...
                scope_id: {
                  description:
                    "Scope ID will be Campaign ID af scope type is either Campaign_Manager or Organization_Manager_Campaign_Subscriber",
                  type: "integer",
                },
              },
              type: "object",
      ...
      properties: {
        requestBody: {
          ...
          properties: {
            commitment: {
              description:
                "A Commitment defines an agreement by a Supporter to raise a specified amount, or meet a certain condition, within a specific timeframe when ticket having commitment is purchased.",
              properties: {
                deadline: {
      ...
      properties: {
        requestBody: {
          ...
          properties: {
                ...
                allOf: [
                  {
                    ...
                    properties: {
                      answer: { description: "Answer content", type: "string" },
                    },
                    type: "object",
                  },
                  {
            ...
            fundraising_page_id: {
              description:
                "ID of the fundraising page to associate the transaction with",
              type: ["null", "integer"],
            },
            fundraising_team_id: {
              description:
                "ID of the fundraising team to associate the transaction with",
              type: ["null", "integer"],
            },
            hide_amount: {
              description:
            ...
            items: {
              description:
                "Collection of Transaction Items. Required for a successful transaction",
              type: ["null", "array"],
              items: {
                title: "Transaction Item Fillable",
                properties: {
            ...
            offline_payment_info: {
              oneOf: [
                {
                  ...
                  properties: {
                    ...
                    sync_third_party: {
                      description:
                        "Sync this offline transaction into third party products such as salesforce",
                      type: ["null", "boolean"],
                    },
                  },
                  type: "object",
              ...
              description:
                "Offline payment info associated to offline transaction",
              type: "object",
            },
  ...
  updateCampaignChannel: tool({
    ...
    parameters: jsonSchema<any>({
      ...
      properties: {
        ...
        campaign_channel_id: { type: "integer" },
      },
    }),
    execute: async (args) => {
      ...
      properties: {
        requestBody: {
          properties: {
            duplicates: {
              description:
                "List of resources associated with the campaign that should also be duplicated",
              type: "array",
              items: {
                type: "string",
                enum: [
            ...
            overrides: {
              ...
              properties: {
                ...
                external_url: {
                  description:
                    "When set on a Campaign, classy.org will push all requests for this Campaign to the specified URL via HTTP redirect. Commonly used to redirect traffic from ended Campaign to another Site/Campaign",
                  type: ["null", "string"],
                },
                goal: {
                  description:
                ...
                raw_currency_code: {
                  description:
                    "ISO code of the currency in which this Campaign should be presented. Defaults to currency_code if not specified",
                  type: "string",
                },
                raw_goal: {
                ...
                dcf_allowed: {
                  description:
                    "If true, this means the campaign must be treated as a dcf campaign",
                  type: "boolean",
                  readOnly: true,
                },
                ...
                use_intelligent_ask_onetime: {
                  description:
                    "Toggle Intelligent Ask Amount suggestion engine for One-time donations",
                  type: ["null", "boolean"],
                },
                use_intelligent_ask_recurring: {
                  description:
                    "Toggle Intelligent Ask Amount suggestion engine for Recurring donations",
                  type: ["null", "boolean"],
                },
                whitelist_url: {
                  description:
      ...
      properties: {
        requestBody: {
          ...
          properties: {
            ...
            postal_code: { description: "Zip Code", type: ["null", "integer"] },
            raw_currency_code: {
              description:
                "ISO code of the currency in which this Campaign should be presented. Defaults to currency_code if not specified",
              type: "string",
            ...
            custom_url: { description: "Custom URL", type: ["null", "string"] },
            dcf_enabled: {
              description:
                "If true, give the donor the option to cover the Transaction Fee via Donor Covered Fees calculation",
              type: "boolean",
            ...
            return_url: { description: "Return URL", type: ["null", "string"] },
            send_dedication_emails: {
              description: "If true, send dedication email for donation",
              type: ["null", "boolean"],
            },
  ...
  checkSlugAvailable: tool({
    ...
    parameters: jsonSchema<any>({
      type: "object",
      properties: { custom_url: { type: "string" } },
    }),
    execute: async (args) => {
    ...
    parameters: jsonSchema<any>({
      ...
      properties: {
        requestBody: {
          ...
          properties: {
            body: { description: "The content of the Comment", type: "string" },
          },
          type: "object",
        },
        id: { type: "integer" },
  ...
  fetchDomainSlug: tool({
    ...
    parameters: jsonSchema<any>({
      ...
      properties: {
        ...
        with: {
          type: "array",
          items: { type: "string", enum: ["domain", "fundraising_entity"] },
        },
      },
    }),
    execute: async (args) => {
    ...
    parameters: jsonSchema<any>({
      ...
      properties: {
        requestBody: {
          ...
          properties: {
            email_subdomain: { description: "Email subdomain", type: "string" },
            sms: {
              description: "Details of Engagement Settings for SMS",
              properties: {
                enabled: {
                  description:
                    "Indicates whether SMS is enabled or not in Engagement Settings",
                  type: "boolean",
                },
                phone_numbers: {
            ...
            email: {
              ...
              properties: {
                custom_domain: {
                  description:
                    "Indicates whether custom domain for email is true or false",
                  type: "boolean",
                },
                domain_prefix: {
                ...
                throttling: {
                  description:
                    "Details of throttling:The amount of email messages sent to one ISP or remote server at one tim",
                  properties: {
                    emails_per_day: {
                ...
                dns: {
                  ...
                  properties: {
                    ...
                    spf: {
                      description:
                        "A type of DNS record that identifies which mail servers are permitted to send an email on behalf of your domain",
                      properties: {
                        txt_record: {
                    ...
                    dkim: {
                      description:
                        "DKIM Records include a signature in each email header sent",
                      properties: {
                        txt_record: {
                    ...
                    tracking: {
                      ...
                      properties: {
                        cname: {
                          description:
                            "Cname allow for tracking of opens and clicks",
                          type: "string",
                        },
                        value: {
                        ...
                        valid: {
                          description:
                            "Indicates whether tracking is valid or not",
                          type: "boolean",
                        },
                      },
                      type: "object",
                    ...
                    incoming: {
                      ...
                      properties: {
                        mx_records: {
                          description:
                            "The MX-record contains the host name of the computer(s) that handle the emails for a domain and a prioritization code",
                          type: "array",
                          items: {
                            properties: {
                              priority: {
                        ...
                        valid: {
                          description:
                            "Indicates whether incoming is valid or not",
                          type: "boolean",
                        },
                      },
                      type: "object",
  ...
  listFeedItemLikes: tool({
    description:
      "Retrieves a list of all Likes made for the specified Feed Item",
    parameters: jsonSchema<any>({
      type: "object",
      properties: {
        feed_item_id: { type: "integer" },
  ...
  fetchFeedItem: tool({
    ...
    parameters: jsonSchema<any>({
      type: "object",
      properties: { feed_item_id: { type: "integer" } },
    }),
    execute: async (args) => {
  ...
  listFundraisingPageActivities: tool({
    description:
      "Retrieves a list of all Activities related to the specified Fundraising Page",
    parameters: jsonSchema<any>({
      type: "object",
      properties: {
        fundraising_page_id: { type: "integer" },
        page: { type: "integer" },
        per_page: { type: "integer" },
      },
    }),
  ...
  listFundraisingPageAnswers: tool({
    description:
      "Retrieves list of all Answers related to specified Fundraising Page",
    parameters: jsonSchema<any>({
      type: "object",
      properties: {
        fundraising_page_id: { type: "integer" },
  ...
  fetchFundraisingPage: tool({
    description:
      "Show the Fundraising Page specified by the fundraising_page_id",
    parameters: jsonSchema<any>({
      type: "object",
      properties: {
        fundraising_page_id: { type: "integer" },
        aggregates: { type: "boolean" },
        with: {
          type: "array",
          items: {
            type: "string",
      ...
      properties: {
        requestBody: {
          ...
          properties: {
            ...
            currency_code: {
              description:
                "ISO code of the currency against which this Fundraising Page is normalized.",
              type: ["null", "string"],
            },
            goal: {
            ...
            is_tribute: {
              description:
                "Flag denoting whether Fundraising Page is a tribute to someone",
              type: ["null", "boolean"],
            },
            thankyou_email_text: {
  ...
  deleteFundraisingPage: tool({
    ...
    parameters: jsonSchema<any>({
      type: "object",
      properties: { fundraising_page_id: { type: "integer" } },
    }),
    execute: async (args) => {
      const url = `https://api.classy.org/2.0/fundraising-pages/${args.fundraising_page_id}`;
      const response = await fetch(url, {
  ...
  listFundraisingPageSoftCredits: tool({
    ...
    parameters: jsonSchema<any>({
      type: "object",
      properties: {
        fundraisingPage_id: { type: "integer" },
        page: { type: "integer" },
        per_page: { type: "integer" },
      },
    }),
  ...
  createFundraisingPageStory: tool({
    ...
    parameters: jsonSchema<any>({
      ...
      properties: {
        requestBody: {
          properties: {
            body: { description: "Main content of Story", type: "string" },
            status: {
              description:
                "Indication whether Post is a draft or has been published",
              type: "string",
              enum: ["draft", "published"],
            },
            title: { description: "Title of Post", type: ["null", "string"] },
          },
          type: "object",
        },
        fundraising_page_id: { type: "integer" },
  ...
  createFundraisingPageUpdate: tool({
    ...
    parameters: jsonSchema<any>({
      ...
      properties: {
        requestBody: {
          properties: {
            body: { description: "Main content of Update", type: "string" },
            status: {
              description:
                "Indication whether Post is a draft or has been published",
              type: "string",
            ...
            visibility: {
              description:
                "Visibility of Update (private Updates can only be seen by the Member associated with record)",
              type: "string",
              enum: ["private", "public"],
            },
          },
  ...
  listFundraisingTeamActivities: tool({
    description:
      "Retrieves a list of all Activities related to the specified Fundraising Team",
    parameters: jsonSchema<any>({
      type: "object",
      properties: {
        fundraising_team_id: { type: "integer" },
        page: { type: "integer" },
        per_page: { type: "integer" },
      },
    }),
  ...
  listFundraisingTeamAnswers: tool({
    description:
      "Retrieves list of all Answers related to specified Fundraising Team",
    parameters: jsonSchema<any>({
      type: "object",
      properties: {
        fundraising_team_id: { type: "integer" },
  ...
  listFundraisingTeamDomainSlugs: tool({
    description:
      "Retrieves a list of all Domain Slugs for specified Fundraising Team",
    parameters: jsonSchema<any>({
      type: "object",
      properties: {
        team_id: { type: "integer" },
  ...
  listSubteams: tool({
    description:
      "Retrieves a list of all SubTeams for specified Fundraising Teams",
    parameters: jsonSchema<any>({
      type: "object",
      properties: {
        id: { type: "integer" },
  ...
  listFundraisingTeamSoftCredits: tool({
    ...
    parameters: jsonSchema<any>({
      type: "object",
      properties: {
        fundraisingTeam_id: { type: "integer" },
        page: { type: "integer" },
        per_page: { type: "integer" },
      },
    }),
  ...
  transferFundraisingTeam: tool({
    description:
      "Transfer a Fundraising Team within its Campaign/subteam infrastructure.",
    parameters: jsonSchema<any>({
      type: "object",
      properties: {
        requestBody: {
      ...
      properties: {
        requestBody: {
          properties: {
            ...
            visibility: {
              description:
                "Visibility of Update (private Updates can only be seen by the Member associated\n    with record)",
              type: "string",
              enum: ["private", "public"],
            },
          },
  ...
  listMemberCampaigns: tool({
    description:
      "Fetches a collection of Campaigns to which this Member has administration access",
    parameters: jsonSchema<any>({
      type: "object",
      properties: {
        id: { type: "integer" },
  ...
  listMemberFundraisingTeams: tool({
    description:
      "Retrieves a list of all Fundraising Teams for the specified Member",
    parameters: jsonSchema<any>({
      type: "object",
      properties: {
        member_id: { type: "integer" },
  ...
  listMemberLeadingFundraisingTeams: tool({
    description:
      "Retrieves a list of all Fundraising Teams for which the specified Member is the team lead",
    parameters: jsonSchema<any>({
      type: "object",
      properties: {
        member_id: { type: "integer" },
  ...
  listOrganizationAnswers: tool({
    description:
      "Retrieves list of all Answers related to specified Organization",
    parameters: jsonSchema<any>({
      type: "object",
      properties: {
        organization_id: { type: "integer" },
  ...
  listOrganizationFundraisingTeams: tool({
    description:
      "Retrieves a list of all Fundraising Teams for the specified Organization",
    parameters: jsonSchema<any>({
      type: "object",
      properties: {
        organization_id: { type: "integer" },
  ...
  listOrganizationFundraisingTeamPolicies: tool({
    description:
      "Retrieves a list of all Fundraising Team Policies for the specified Orgnaization",
    parameters: jsonSchema<any>({
      type: "object",
      properties: {
        org_id: { type: "integer" },
          ...
          allOf: [
            {
              ...
              properties: {
                ...
                primary_color: { description: "Primary color", type: "string" },
                secondary_color: {
  ...
  listOrganizationChannel: tool({
    description:
      "Retrieves a list of all Channels for the specified Organization",
    parameters: jsonSchema<any>({
      type: "object",
      properties: {
        org_id: { type: "integer" },
  ...
  listOrganizationCredentialSets: tool({
    description:
      "Retrieves a list of all Credential Sets for the specified Organization",
    parameters: jsonSchema<any>({
      type: "object",
      properties: {
        org_id: { type: "integer" },
  ...
  listOrganizationNotifications: tool({
    description:
      "Retrieves a list of all Nofications made for the specified Organization",
    parameters: jsonSchema<any>({
      type: "object",
      properties: {
        org_id: { type: "integer" },
  ...
  fetchPaypalStripePayouts: tool({
    description:
      "Fetch all payouts for a specific Organization on a given payout date",
    parameters: jsonSchema<any>({
      type: "object",
      properties: {
        org_id: { type: "integer" },
  ...
  listOrganizationQuestions: tool({
    description:
      "Retrieves a list of all questions for a specific Organization",
    parameters: jsonSchema<any>({
      type: "object",
      properties: {
        org_id: { type: "integer" },
  ...
  listOrganizationRecurringDonationPlans: tool({
    description:
      "Retrieves a list of all Recurring Donation Plans for a specific Organization",
    parameters: jsonSchema<any>({
      type: "object",
      properties: {
        organization_id: { type: "integer" },
  ...
  listOrganizationRegistrations: tool({
    description:
      "Retrieves a list of all Registrations for a specific Organization",
    parameters: jsonSchema<any>({
      type: "object",
      properties: {
        organization_id: { type: "integer" },
  ...
  listOrganizationRestrictedCountries: tool({
    description:
      "Retrieves a list of all blacklisted countries for the specified Organzation",
    parameters: jsonSchema<any>({
      type: "object",
      properties: {
        organization_id: { type: "integer" },
  ...
  listOrganizationSourceTrackingCodes: tool({
    description:
      "Lists all Source Tracking Codes which are managed by the specified Organization.",
    parameters: jsonSchema<any>({
      type: "object",
      properties: {
        organization_id: { type: "integer" },
  ...
  listAsrMessages: tool({
    description:
      "Retrieves an array with recipientsIds, template_name, year and message_id for Annual Summary Report wrt Supporters for a specific Organization",
    parameters: jsonSchema<any>({
      type: "object",
      properties: {
        organization_id: { type: "integer" },
  ...
  listOrganizationTicketTypes: tool({
    description:
      "Retrieve a list of all the Ticket Types for the given Organization.",
    parameters: jsonSchema<any>({
      type: "object",
      properties: {
        organization_id: { type: "integer" },
  ...
  listOrganizationTransactionItems: tool({
    ...
    parameters: jsonSchema<any>({
      ...
      properties: {
        ...
        with: {
          type: "array",
          items: { type: "string", enum: ["transaction"] },
        },
        page: { type: "integer" },
        per_page: { type: "integer" },
      },
  ...
  fetchOrganizationCredentialSet: tool({
    ...
    parameters: jsonSchema<any>({
      ...
      properties: {
        ...
        with: {
          type: "array",
          items: { type: "string", enum: ["member", "organization"] },
        },
      },
    }),
    execute: async (args) => {
  ...
  listPromoCodeConfigurations: tool({
    description:
      "Retrieves a list of all Promo Code Configurations for the specified Promo Code",
    parameters: jsonSchema<any>({
      type: "object",
      properties: {
        ...
        with: {
          type: "array",
          items: { type: "string", enum: ["ticket_type"] },
        },
        page: { type: "integer" },
        per_page: { type: "integer" },
      },
  ...
  listRecurringDonationPlanTransactions: tool({
    ...
    parameters: jsonSchema<any>({
      type: "object",
      properties: {
        recurring_donation_plan_id: { type: "integer" },
        page: { type: "integer" },
        per_page: { type: "integer" },
      },
    }),
  ...
  fetchRecurringDonationPlan: tool({
    ...
    parameters: jsonSchema<any>({
      type: "object",
      properties: { recurring_donation_plan_id: { type: "integer" } },
    }),
    execute: async (args) => {
  ...
  listRegistrationAnswers: tool({
    description:
      "Retrieves list of all Answers related to specified Registration",
    parameters: jsonSchema<any>({
      type: "object",
      properties: {
  ...
  fetchRegistration: tool({
    ...
    parameters: jsonSchema<any>({
      type: "object",
      properties: { registration_id: { type: "integer" } },
    }),
    execute: async (args) => {
      ...
      properties: {
        requestBody: {
          ...
          properties: {
            ...
            city: { description: "City field of Registration", type: "string" },
            state: {
            ...
            company: { description: "Name of the company", type: "string" },
            website: { description: "Website of registrant", type: "string" },
            blog: { description: "Blog of registrant", type: "string" },
            gender: {
            ...
            tshirt_size: { description: "Size of tshirt", type: "string" },
          },
          type: "object",
        },
        registration_id: { type: "integer" },
  ...
  updateReprocessAttemptInfo: tool({
    ...
    parameters: jsonSchema<any>({
      ...
      properties: {
        ...
        reprocess_transaction_id: { type: "integer" },
      },
    }),
    execute: async (args) => {
  ...
  fetchSupporter: tool({
    ...
    parameters: jsonSchema<any>({
      type: "object",
      properties: { supporter_id: { type: "integer" } },
    }),
    execute: async (args) => {
  ...
  listTicketTypePromoCodeConfigurations: tool({
    description:
      "Retrieves a list of all Promo Code Configurations for the specified Ticket Type",
    parameters: jsonSchema<any>({
      type: "object",
      properties: {
        ...
        with: {
          type: "array",
          items: { type: "string", enum: ["promo_code"] },
        },
        page: { type: "integer" },
        per_page: { type: "integer" },
      },
  ...
  listTicketTypesPromoCodes: tool({
    description:
      "Retrieves a list of all Promo Codes made for the specified Ticket Type",
    parameters: jsonSchema<any>({
      type: "object",
      properties: {
        ticket_types_id: { type: "integer" },
        page: { type: "integer" },
        per_page: { type: "integer" },
      },
    }),
  ...
  listAcknowledgements: tool({
    description:
      "Retrieves a list of all Acknowledgements made for the specified Transaction",
    parameters: jsonSchema<any>({
      type: "object",
      properties: {
        transaction_id: { type: "integer" },
  ...
  listTransactionAnswers: tool({
    description:
      "Retrieves list of all Answers related to specified Transaction",
    parameters: jsonSchema<any>({
      type: "object",
      properties: {
        transaction_id: { type: "integer" },
          ...
          properties: {
            ...
            to: {
              properties: {
                ...
                id: { description: "ID of the page", type: "integer" },
              },
              type: "object",
            },
          },
